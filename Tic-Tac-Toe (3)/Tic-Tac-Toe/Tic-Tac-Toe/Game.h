...
void checkToWin(char square[], int player)     //check for a winning combination
{
    ...
    {
        cout << "Player" << player << " won!" << endl << endl;      //print out the winner
        returnToMenu();     //return to the menu
    }
...
void game()
{
    ...
    while (turn < 9)
    {
        ...
        cout << "Player" << player << "'s turn" << endl << endl;    //print out whose turn it is
    ...
    if (turn == 9)     //it's a draw. There isn't a winner
    {
